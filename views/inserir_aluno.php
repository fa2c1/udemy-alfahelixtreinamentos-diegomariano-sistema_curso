...
<?php if(!isset($_GET['editar'])){ ?>
  ...
  <form method="post" action="processa_aluno.php">
    ...
    <input type="text" name="data_nascimento" placeholder="Insira a data de nascimento"><br><br>
      ...
      <?php if($linha['id_aluno'] == $_GET['editar']){ ?>
        <h1>Editar aluno</h1>
          <form method="post" action="edita_aluno.php">
            ...
            <br><br>
            <label>Data de nascimento:</label><br>
            <input type="text" name="data_nascimento" placeholder="Insira a data de nascimento" value="<?php echo $linha['data_nascimento']; ?>"><br><br>
